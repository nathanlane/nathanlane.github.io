...
--baseline: 1.5rem;    /* 24px = 4 grid units */
```
...
```css
--space-major-third: 3rem;     /* 48px */
--space-minor-third: 2.25rem;  /* 36px */
--space-perfect-fourth: 1rem;  /* 16px */
```
...
<section class="py-space-xl">
  <h2 class="mb-space-2xs mt-space-l">Section Title</h2>
  <p class="mb-space-s">Paragraph with baseline-aligned spacing.</p>
</section>
