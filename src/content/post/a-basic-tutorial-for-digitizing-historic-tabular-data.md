...
publishDate: 2014-10-04T00:00:00.000Z
tags:
  - finereader
  - ocr
  - python
...
Once loaded into FineReader, you will likely want to further clean the scans using the built-in pre-processing tools (**"Edit Image"**). One tool that is particularly useful is FineReader's optimal resolution tool, which scales the resolution of the image to maximize recognition.
