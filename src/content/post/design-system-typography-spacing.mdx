...
description: "A comprehensive guide to the fluid typography and mathematical grid system that powers this website's design"
publishDate: "July 14 2025"
tags: ["typography", "design-systems", "css", "documentation"]
draft: false
---
...
<h1 class="text-4">Display Heading</h1>
<p class="text-0">Body text scales smoothly...</p>
<small class="text--1">Small print</small>
```
