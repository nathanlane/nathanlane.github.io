...
<h1 class="heading-1">Site Hero</h1>
```
...
Remember: great typography is invisible when it works, but painfully obvious when it doesn't. Take time to understand your tools, test thoroughly, and document your decisions. Your readers—and future self—will thank you.
