...
description: "How I solved the semantic HTML vs visual design dilemma by rebasing heading styles"
publishDate: "2025-07-16"
tags: ["accessibility", "typography", "html", "css", "web-development"]
draft: false
---
...
<h2 class="heading-2">Writing</h2>

<!-- Section headers -->
<h3 class="heading-3">Featured Writing</h3>
```
...
```html
<h1 class="heading-1">Extra Large Title</h1>
```
