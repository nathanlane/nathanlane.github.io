...
:root {
  ...
  /* Subtle weight increase for headings */
  --heading-weight-adjustment: 50;
}

/* Dark mode adjustments */
:root[data-theme="dark"] {
  /* Increase weights slightly for better contrast */
  --body-weight-regular: 425;
  --body-weight-medium: 525;
  --body-weight-semibold: 625;
}
...
:root {
  ...
  /* Scale ratio increases on larger screens */
  --scale-ratio: clamp(1.2, 1.15 + 0.25vw, 1.25);
...
Remember: typography is not about fonts—it's about reading. Every optimization should serve that fundamental purpose.
