...
description: Taking Geospatial Data to R (& how to ditch ArcGIS)
...
Moreover, it's pretty straightforward to perform common manipulations of raster data, such as changing the changing the CRS. One can change the projection by using the <code>reprojectRaster()</code> function followed by the <code>resample()</code> function.
...
![Image](/images/blog/assets/globen.jpg)
...
![Image](/images/blog/assets/sweden.jpg)
...
For instance, using the <code>ncdf4</code> library I can load a giant NetCDF file directly; together with the <code>raster</code> library's <code>brick()</code> function, you get load an entire NetCDF file and recognize it as a RasterBrick with minimal fuss
