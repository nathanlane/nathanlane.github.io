...
description: "How to migrate from native HTML images to Astro's optimized Image component for better performance and user experience."
publishDate: 2024-01-15
tags: ["astro", "performance", "images", "optimization", "tutorial"]
draft: false
---
...
---
import { Image } from 'astro:assets';
const { coverImage, coverImageAlt } = post.data;
---
...
- [ ] Move headshot.jpg to src/assets/images/
- [ ] Update aboutConfig to use imported image

### Blog Post Images
- [ ] Update schema to use image() helper
- [ ] Migrate existing post images to src/assets/
