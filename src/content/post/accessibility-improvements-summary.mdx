...
description: "A comprehensive summary of accessibility improvements made to ensure WCAG 2.1 AA compliance"
publishDate: "2025-07-16"
tags: ["accessibility", "wcag", "performance", "documentation"]
draft: false
---
...
2. **Improved dark mode text colors**
   ```css
   /* Light text colors now meet WCAG AA */
   --theme-lightest: hsl(40deg 5% 75%); /* Up from 65% */
   --theme-lighter: hsl(40deg 5% 70%);  /* Up from 55% */
   --theme-light: hsl(40deg 5% 65%);    /* Up from 50% */
   ```
