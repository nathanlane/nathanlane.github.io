export const aboutConfig = {
	meta: {
		title: "About",
		description: "About Nathan Lane, PhD, Economist and Data Scientist",
	},
	photo: {
		show: true,
		src: "/headshot.jpg",
	...
	content: {
		intro:
			"Nathan Lane is an Associate Professor of Economics at Oxford University and co-founder of the empirical economics research lab, the Industrial Policy Group, with Dr. Réka Juhász (University of British Columbia).",
		paragraphs: [
			"His research interests span big data, machine learning, economic development, political economy, and industrial economics. Before joining Oxford, Dr. Lane was an economics professor at Monash University and co-founder of SodaLabs.io, a lab dedicated to answering social science questions using alternative data and computational tools. He previously served as a postdoctoral researcher at the Massachusetts Institute of Technology for Professor Daron Acemoglu.",
