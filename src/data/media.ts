  ...
  2025: [
    {
      ...
      description: "Economists say the region's planned defense buildup might be exactly what its economy needs, despite some sizable hurdles"
    },
    {
      ...
      description: "Analysis of how tariffs aren't the only policy tool Donald Trump wants to use to shape the US economy, including his attraction to industrial policy through subsidies, regulation, and government interventions"
    },
    {
      title: "Rich country playbook: Why developed nations win, while Kazakhstan gets left behind",
      ...
      description: "Analysis referencing research by Réka Juhász, Nathan Lane, Emily Oehlsen and Veronica Perez on measuring industrial policy through text-based data analysis"
    },
    {
      ...
      description: "Podcast discussion featuring Nathan Lane's research alongside papers from the IMF and RAND Corporation on industrial policy (segment starts at 12:21)"
    },
    {
      ...
      description: "Econometric study finding that industrial subsidies increase firms' market shares but have no or negative impacts on investment rates and productivity growth"
    },
    {
      title: "India's Industrial Policies: Rejecting the Old Status Quo and Creating the New",
      ...
      description: "Analysis of India's industrial policies including PLIs, tariffs, and domestic content requirements, citing 'The New Economics of Industrial Policy' by Juhász, Lane, and Rodrik"
    },
    {
      title: "The promise and pitfalls of production subsidies as industrial policy",
      ...
      description: "World Bank blog post by Gaurav Nayyar discussing how tax holidays in Korea during the 1970s, combined with duty-free access to intermediate inputs, resulted in export gains and downstream industry expansion (Lane 2022)"
    },
    {
      ...
      description: "UK Government research and analysis publication citing Nathan Lane's work on industrial policy evidence and effectiveness"
    },
    {
      ...
      description: "Joachim Klement recommends recent overview by Réka Juhász and Nathan Lane on what makes industrial policy powerful and how to design good industrial policy"
    }
  ],
  2024: [
    {
      ...
      description: "Industrial policy insights highlighting challenges for developing countries"
    },
    {
      ...
      description: "Coverage of research showing industrial policy must focus on services, not just manufacturing"
    },
    {
      title: "Assessing India's Production-linked Incentives: A Case for Realignment of Objectives",
      ...
      description: "Analysis of India's PLI scheme design flaws and recommendations for realignment to better support domestic manufacturing"
    },
    {
      title: "Interview with Nathan Lane by Srijana Mitra Das (India: Economic Times)",
      ...
      description: "Interview with Nathan Lane by Srijana Mitra Das discussing the modern return of industrial policy in the context of globalization, climate change, and artificial intelligence"
    },
    {
      ...
      description: "Panel discussion at HKS with Nathan Lane, Myrto Kalouptsidi, and Rohit Lamba, moderated by Dani Rodrik, on the evolution and effectiveness of industrial policy"
    },
    {
    ...
    },
    {
      ...
      description: "Global Industrial Policy: Measurement and Results - increased interest reflected in real data"
    },
    {
      ...
      description: "Swedish article on how industrial policy and protectionism can threaten world trade without making Western economies safer"
    },
    {
    ...
    },
    {
      ...
      description: "Cristina Caffarra and Nathan Lane discuss how new industrial policy and competition interact, arguing industrial policy is not merely a side consideration"
    },
    {
      ...
      description: "Nathan Lane discusses US industrial policy on The Ballpark Podcast from LSE's US Centre"
    }
  ],
  2023: [
    {
      ...
      description: "Commentary on new economics of industrial policy and green transition"
    },
    {
      title: "A few economists are starting to take industrial policy seriously",
      outlet: "Noahpinion",
      date: "2023-10-04",
      type: "article",
      link: "https://www.noahpinion.blog/p/a-few-economists-are-starting-to",
      description: "Noah Smith discusses the Industrial Policy Group led by Réka Juhász and Nathan Lane, who've compiled reviews of past research and are making the case that industrial policy is a worthy topic of study"
    },
    {
      ...
      description: "Greg Ip discusses how Réka Juhász and Nathan Lane founded the Industrial Policy Group to conduct empirical research and compiled a database of industrial policy actions from 2009-2020"
    },
    {
      ...
      description: "Nathan Lane discusses South Korea's industrial policy with Chad Bown on Trade Talks podcast episode 189"
    },
    {
      ...
      description: "Analysis of Bidenomics approach to industrial policy and economic development"
    },
    {
      ...
      description: "Features Nathan Lane discussing the empirical turn in economics and exploring industrial policy despite ideological resistance"
    },
    {
      title: "The Biden Administration Can Learn From The States—Industrial Policy Doesn't Work",
      outlet: "Forbes",
      date: "2023-08-16",
      type: "article",
      ...
      description: "Adam Millsap's critique of industrial policy effectiveness based on state-level experiences"
    },
    {
      ...
      description: "Op-ed by Réka Juhász and Nathan Lane on industrial policy research"
    },
    {
    ...
    },
    {
      ...
      description: "Nathan Lane discusses industrial policy on CEPR's Conversations on Transformation series, narrated by Tim Phillips"
    },
    {
      title: "Governments across the world are discovering 'homeland economics'",
      outlet: "The Economist",
      date: "2023-10-02",
      type: "article",
      link: "https://www.economist.com/special-report/2023/10/02/governments-across-the-world-are-discovering-homeland-economics",
      description: "Special report by Callum Williams arguing that introducing industrial policy is a big mistake"
    }
  ]
};