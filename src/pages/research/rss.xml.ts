...
export const GET = async () => {
  ...
  const sortedResearch = research.sort((a, b) => 
    parseInt(b.data.paperDate) - parseInt(a.data.paperDate)
  );

  return rss({
    title: `${siteConfig.title} - Research Papers`,
    description: "Academic research papers, working papers, and reports on economic development, state formation, and computational methods.",
